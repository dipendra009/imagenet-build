...
def main():
  ...
  train_image_to_bboxes = _build_bounding_box_lookup(train_bbox_file)
  val_image_to_bboxes = _build_bounding_box_lookup(val_bbox_file)

  # Run it!
  _process_dataset('validation', validation_directory,
                   validation_shards, synset_to_human, val_image_to_bboxes)
